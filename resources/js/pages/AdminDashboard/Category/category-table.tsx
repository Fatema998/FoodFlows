        ...
        return (
            <React.Fragment key={category.id}>
                <TableRow className={rowClasses}>
                    ...
                    {/* Name column */}
                    <TableCell className={`px-4 py-2 text-sm ${level === 0 ? 'text-black dark:text-white' : 'text-gray-800 dark:text-gray-200'} font-medium`}>
                        {category.name}
                    </TableCell>
                ...
                {category.children &&
                    ...
                    category.children.map((child, childIndex) =>
                        renderCategoryRow(child, childIndex, rowIndex, level + 1)
                    )}
            </React.Fragment>
        );
    };
            ...
            <div className="max-w-full overflow-x-auto">
                <Table className="min-w-full">
                    <TableHeader className="border-b border-gray-200 bg-gray-100 dark:border-white/[0.05] dark:bg-gray-800">
                        <TableRow>
                            <TableCell className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>#</TableCell>
                            <TableCell className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Name</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Image</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Product Count</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Status</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Position</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Date</TableCell>
                            <TableCell className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase dark:text-gray-400" isHeader>Actions</TableCell>
                        </TableRow>
                    </TableHeader>
